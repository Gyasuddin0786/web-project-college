...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle fs-1  text-dark offset-2" href="#"
                            id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        services
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item fs-2" href="reviews.php">Dental Implants</a></li>
                            <hr class="dropdown-divider">

                            <li><a class="dropdown-item fs-2" href="login.php">Smile Makeover</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item fs-2" href="contact.php">Teeth Whitening</a></li>
                            <hr class="dropdown-divider">

                            <li><a class="dropdown-item fs-2" href="galary.php">Full mouth Rehabhulation</a></li>
                        </ul>
                    </li>&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
    ...
    <!-- header section ends -->
        ...
        <div class="box-container container">
            <div class="box">
                <img src="image/Alignment Specialist.png" alt="image not found">
                <h3>Alignment specialist</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            <div class="box">
                <img src="image/Dentalchecker.png" alt="image not found">
