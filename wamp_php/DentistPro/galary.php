...
<body>
    ...
    <!-- header section ends -->
        ...
        <section class="services bg-light border border-info" id="services">
        <h1 class="heading">our galary</h1>
        <div class="box-container container">
            <div>
                <img src="image/1.png"
                    style="width: 300px; height: 160px; border-radius: .6rem; transition: transform 0.3s ease;">
            </div>
            <div>
                <img src="image/2.png"
                    style="width: 300px; height: 160px; border-radius: .6rem; transition: transform 0.3s ease;">
