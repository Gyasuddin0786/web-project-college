...
<body>
    ...
    <section class="process border mt-5 mb-5">
        <h1 class="heading">work process</h1>
        <div class="box-container container">
            <div class="box">
                <img src="image/work process-1.png" alt="">
                <h3>Cosmetic dentistry</h3>
                <p>Cosmetic dentistry focuses on improving the appearance and aesthetics of your smile.</p>
            </div>
            <div class="box">
                <img src="image/work process-2.png" alt="">
                <h3>Pendiatric dentistry</h3>
                <p>Pediatric dentists are dedicated to the oral health
                    of children from infancy through the teen years.</p>
            </div>
            <div class="box">
                <img src="image/dental implants.png" alt="">
                <h3>Dental Implants</h3>
                <p>Dental implants are artificial structures that replace missing teeth.</p>
            </div>
            <div class="box">
                <img src="image/work process-2.png" alt="">
                <h3>Pendiatric dentistry</h3>
