    ...
    <section id="about" class="about">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="image">
                    <img src="image/Pateint.jpg" class="w-100 mb-8 md-10" alt="image not found">
                </div>
                <div class="row-md-6 content mt-5">
                    <span id="span" class="text-danger fs-1">about us</span>
                    <h3 id="h3" class="fs-2">True Healthcare For Your Family</h3>
                    <p id="p" class="fs-3 p-1 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Suscipit, sint?</p>
                    <a href="#contact" class="link-btn mb-1 mt-2">make appointment</a>
                </div>
            </div>
        </div>
        </sectio>
