...
$e_id = $_REQUEST['e_id'];
$q = "SELECT * FROM event_details where e_id=$e_id";
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <img src="image/events/<?php echo $row[6]; ?>" class="img-fluid"/>
                    </div>
                    <?php
                    $extras = explode(",", $row[7]);
                    foreach ($extras as $extra_image) { ?>
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <img src="image/events/<?php echo $extra_image; ?>" class="img-fluid"/>
                        </div>
                    <?php
                    }
                    ?>
