...
function education_insight_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'education-insight'), esc_html__('Begin Installation', 'education-insight'), 'edit_theme_options', 'education-insight-guide-page', 'education_insight_guide');
}
...
function education_insight_guide() {
	...
	<div class="getting-started__header">
		...
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( EDUCATION_INSIGHT_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Theme Documentation', 'education-insight'); ?></a>
	...
	<div class="import-box">
		<div class="container">
			<h2><?php esc_html_e( 'DEMO IMPORT', 'education-insight' ); ?></h2>
			<p class="plugin-text"><?php esc_html_e('Before Demo Import first install given plugin, ','education-insight'); ?><span><?php esc_html_e('WooCommerce','education-insight'); ?></span></p>
			<p><?php esc_html_e('To import all of the demo content, click the Begin With Demo Import button.','education-insight'); ?></p>
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('To setup the home page follow the below steps.','education-insight'); ?></p>
