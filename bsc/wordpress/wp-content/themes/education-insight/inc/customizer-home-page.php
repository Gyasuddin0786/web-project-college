 ...
 */
	...
	for ( $s = 1; $s <= 4; $s++ ) {
		...
		$wp_customize->add_control(new Education_Insight_Fontawesome_Icon_Chooser(
	        $wp_customize,'education_insight_mid_section_icon'.$s,array(
			'label'	=> __('Icon','education-insight'),
			'transport' => 'refresh',
			'section'	=> 'education_insight_middle_section',
	...
	$wp_customize->add_setting('education_insight_course_count',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('education_insight_course_count',array(
		'label'	=> esc_html__('Course Count','education-insight'),
		'section'	=> 'education_insight_popular_courses',
		'type'		=> 'number',
		'input_attrs' => array(
			'step'             => 1,
