					...
					<div class="col-lg-7 col-md-9">
						<div class="my-2">
							<?php if( get_theme_mod('education_insight_call') != ''){ ?>
								<span><i class="<?php echo esc_attr(get_theme_mod('education_insight_call_icon','')); ?>"></i><?php echo esc_html(get_theme_mod('education_insight_call','')); ?></span>
							<?php }?>
							<?php if( get_theme_mod('education_insight_email') != ''){ ?>
								<span><i class="<?php echo esc_attr(get_theme_mod('education_insight_email_icon','')); ?>"></i><?php echo esc_html(get_theme_mod('education_insight_email','')); ?></span>
							<?php } ?>
